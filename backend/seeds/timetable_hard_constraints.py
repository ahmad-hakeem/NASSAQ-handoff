...
TIMETABLE_HARD_CONSTRAINTS = [
    ...
    },
    {
        ...
        "description_ar": "اكتمال جميع الحصص المطلوبة لكل فصل ومادة هدف مرغوب. إذا تعذّر جدولة بعض الحصص بسبب قيود غير قابلة للحل، يظهر النقص كتنبيه ولا يمنع النشر، ويتم عرض الحصص الناقصة للمدير.",
        "description_en": "Completing all required sessions for every class and subject is the goal. If some sessions cannot be scheduled due to unavoidable constraints, the shortfall is surfaced as a warning and does not block publishing; the missing sessions are shown to the principal.",
