...
def upgrade() -> None:
    ...
    op.create_index('ix_daily_tasks_tenant_id', 'daily_tasks', ['tenant_id'])
    ...
    op.create_index('ix_daily_tasks_source', 'daily_tasks', ['source'])
    op.create_index('ix_daily_tasks_task_date', 'daily_tasks', ['task_date'])
    op.create_index('idx_daily_tasks_user_date', 'daily_tasks', ['user_id', 'task_date'])
    op.create_index('idx_daily_tasks_tenant_date', 'daily_tasks', ['tenant_id', 'task_date'])
    op.create_index('idx_daily_tasks_user_status', 'daily_tasks', ['user_id', 'status'])
