...
from src.common.dto.enums import UserRole  # backend/ is on sys.path; matches existing convention
...
async def tenant_scoped_find_one(
    ...
    *,
    ...
    if not tenant_id:
        ...
        from src.core.guards.tenant_guard import independent_workspace_id  # local: avoid cycle
