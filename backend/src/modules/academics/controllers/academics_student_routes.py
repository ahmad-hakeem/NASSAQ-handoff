...
from src.common.utils.stage_grade import normalize_stage
...
async def get_class_students(
    ...
    if current_user.get("role") == UserRole.TEACHER.value:
        from src.common.utils.tenant_scope import can_view_class, require_can_view_class_sync_check
    ...
    if current_user.get("role") != UserRole.PLATFORM_ADMIN.value:
        if current_user.get("role") == UserRole.INDEPENDENT_TEACHER.value:
            from src.common.utils.collab_access import caller_collab_row_for_class
...
async def update_student(
    ...
    from src.core.guards.tenant_guard import is_independent_teacher as _is_independent_teacher
