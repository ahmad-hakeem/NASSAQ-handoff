"""
IndependentTeacher Controller
= NestJS @Controller()

HTTP endpoints for IndependentTeacher.
During Phase 4 migration: delegates to existing route files.
Target: inline all endpoints directly here.
"""
from fastapi import APIRouter

router = APIRouter(tags=["IndependentTeacher"])
...
# ── Route delegation (Phase 4 migration — replace with inline endpoints) ────
    ...
    router.include_router(_independent_teacher_workspace_lifecycle_routes_router)
    ...
    router.include_router(_independent_teacher_analytics_routes_router)
    ...
    router.include_router(_independent_teacher_schedule_routes_router)
    ...
    router.include_router(_independent_teacher_collab_routes_router)
    ...
    router.include_router(_independent_teacher_bulk_import_routes_router)
    ...
    router.include_router(_independent_teacher_invitation_routes_router)
    ...
    router.include_router(_independent_teacher_parents_routes_router)
    ...
    router.include_router(_independent_teacher_audit_routes_router)
    ...
    router.include_router(_independent_teacher_lesson_plans_routes_router)
    ...
    router.include_router(_independent_teacher_notifications_routes_router)
    ...
    router.include_router(_independent_teacher_search_routes_router)
    ...
    router.include_router(_independent_teacher_reports_routes_router)
    ...
    router.include_router(_independent_teacher_workspace_excel_export_routes_router)
    ...
    router.include_router(_independent_teacher_workspace_settings_routes_router)
    ...
    router.include_router(_independent_teacher_communication_routes_router)
    ...
    router.include_router(_independent_teacher_invite_parent_routes_router)
    ...
    router.include_router(_independent_teacher_calendar_routes_router)
    ...
    router.include_router(_independent_teacher_bulk_extensions_routes_router)
    ...
    router.include_router(_independent_teacher_bootstrap_routes_router)
    ...
    router.include_router(_independent_teacher_onboarding_routes_router)
