...
async def system_alerts(current_user: dict = Depends(require_roles([UserRole.PLATFORM_ADMIN]))):
    ...
    try:
        from src.core.middleware.rate_limiter import get_rate_limiter_health
...
async def system_metrics(current_user: dict = Depends(require_roles([UserRole.PLATFORM_ADMIN]))):
    ...
    response_metrics = {}
    try:
        from src.core.middleware.request_tracing import get_response_metrics
    ...
    cache_metrics = {}
    try:
        from src.core.middleware.cache_metrics import get_cache_metrics
    ...
    try:
        ...
        from src.core.middleware.query_monitor import get_pool_stats
