...
async def get_teacher_dashboard(
    ...
    from src.core.guards.tenant_guard import is_independent_teacher as _is_it, independent_workspace_id as _itw_id
    ...
    if current_user.get("role") not in ADMIN_ROLES:
        ...
        if not assignment:
            ...
            if not class_session:
                ...
                from src.common.utils.collab_access import caller_can_access_class
...
async def _verify_session_owner(session_id: str, current_user: dict, *, allow_admin: bool = True):
    ...
    """
    from src.common.utils.tenant_scope import _is_platform_admin
