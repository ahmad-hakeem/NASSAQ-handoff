...
from src.common.utils.tenant_scope import resolve_school_id, _is_platform_admin
...
async def _deliver_it_session_summary(
    ...
    """
    from src.core.guards.tenant_guard import independent_workspace_id as _itw
    from src.modules.independent_teacher.controllers.independent_teacher_communication_routes import (
        _resolve_workspace_teacher_id,
        _resolve_my_parents_recipients,
    )
...
async def create_notification(
    ...
    if (
        ...
        from src.core.guards.tenant_guard import independent_workspace_id as _itw_log
