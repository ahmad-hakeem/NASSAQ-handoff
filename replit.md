...
12. **Student Enrollment Engine** (12 ep) — `registration_routes_mod.py` — Teacher registration + student enrollment (create/list/approve/reject), additional info workflow.
