...
jest.mock('../../components/wizards/CreateSchoolWizard', () => ({ __esModule: true, default: () => <div /> }));
jest.mock('../../components/wizards/CreateUserWizard', () => ({ __esModule: true, default: () => <div /> }));
...
jest.mock('../../components/ai/QuickAIOperationsPanel', () => ({
  __esModule: true,
...
const QuickAIOperationsPanel = require('../../components/ai/QuickAIOperationsPanel').default;
