          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <Card className="border-0 shadow-sm bg-gradient-to-br from-blue-50 to-blue-100">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-xs text-blue-600">{isRTL ? 'إجمالي الحصص' : 'Total Sessions'}</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-sm bg-gradient-to-br from-green-50 to-green-100">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-xs text-green-600">{isRTL ? 'مكتملة' : 'Completed'}</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-sm bg-gradient-to-br from-red-50 to-red-100">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-xs text-red-600">{isRTL ? 'ملغاة' : 'Cancelled'}</div>
              </CardContent>
            </Card>
            <Card className="border-0 shadow-sm bg-gradient-to-br from-purple-50 to-purple-100">
              <CardContent className="p-4 text-center">
                ...
                <div className="text-xs text-purple-600">{isRTL ? 'متوسط الحضور' : 'Avg Attendance'}</div>
              </CardContent>
            </Card>
          </div>
