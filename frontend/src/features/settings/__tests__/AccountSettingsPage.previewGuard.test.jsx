...
jest.mock('@/features/teachers/components/teacher/TeachingStatsHero', () => () => null);
...
jest.mock('@/shared/components/ui/ResponsiveTable', () => ({ ResponsiveTable: () => null }));
jest.mock('@/shared/hooks/useWorkspaceHubData', () => ({ useWorkspaceHubData: () => ({}) }));
jest.mock('@/features/teachers/pages/TeacherModule', () => ({ TeacherAuditLogPanel: () => null }), { virtual: true });
