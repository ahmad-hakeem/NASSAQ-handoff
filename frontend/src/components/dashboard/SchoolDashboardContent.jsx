...
const AnalyticsSummaryCard = ({ isRTL, onNavigate }) => {
  const { api } = useAuth();
    ...
    <Card className="card-nassaq overflow-hidden">
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <button onClick={() => onNavigate('/principal/ai-insights')}
      ...
      <CardContent>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          <div className="text-center p-3 rounded-xl bg-green-50 dark:bg-green-950/30">
            ...
            <p className="text-xl font-bold font-cairo text-green-600">{d.attendanceRate}%</p>
            <p className="text-[10px] text-muted-foreground font-tajawal">{isRTL ? 'الحضور' : 'Attendance'}</p>
          </div>
          <div className="text-center p-3 rounded-xl bg-blue-50 dark:bg-blue-950/30">
            ...
            <p className="text-xl font-bold font-cairo text-blue-600">{d.avgGrade || '-'}</p>
            <p className="text-[10px] text-muted-foreground font-tajawal">{isRTL ? 'المعدل' : 'Avg Grade'}</p>
          </div>
          <div className="text-center p-3 rounded-xl bg-emerald-50 dark:bg-emerald-950/30">
            ...
            <p className="text-xl font-bold font-cairo text-emerald-600">{d.positiveBehavior}</p>
            <p className="text-[10px] text-muted-foreground font-tajawal">{isRTL ? 'سلوك إيجابي' : 'Positive'}</p>
          </div>
          <div className="text-center p-3 rounded-xl bg-red-50 dark:bg-red-950/30">
            ...
            <p className="text-xl font-bold font-cairo text-red-600">{d.negativeBehavior}</p>
            <p className="text-[10px] text-muted-foreground font-tajawal">{isRTL ? 'سلوك سلبي' : 'Negative'}</p>
          </div>
        </div>
      </CardContent>
    </Card>
