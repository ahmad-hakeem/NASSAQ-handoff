...
const PAGE_CONTEXT_MAP = {
  ...
  '/school/analytics': { name: 'التحليلات', suggestions: ['ما أهم المؤشرات؟', 'كيف أداء المدرسة هذا الأسبوع؟'] },
  '/school/reports': { name: 'التقارير', suggestions: ['ما التقارير المتاحة؟', 'كيف أصدّر تقرير؟'] },
